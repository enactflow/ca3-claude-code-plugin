---
name: ca3
description: Use CA3 as Claude Code's user-owned context and memory layer. Trigger for continuing selected work, recalling prior decisions or material, and intentionally saving durable context across agents.
---
...
or reconnect the plugin and start a new session before treating the server
