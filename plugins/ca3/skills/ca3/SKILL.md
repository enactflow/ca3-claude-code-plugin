---
name: ca3
description: Bootstrap CA3 usage in Claude Code. Use the live CA3 MCP tool list and tool descriptions as the source of truth for notes, memory, and personalization behavior.
---

# CA3

CA3 is a user-owned memory hub shared by Claude Code, Codex, ChatGPT, and other MCP clients.
